...
IPAddress staticIP(192, 168, 1, 128); //ESP static ip
...
const char* deviceName = "detector";
String serverUrl = "192.168.1.252";
String payload;
String device_key = "pirsesorsecret";
...
void buttonStateChange() {
  ...
  if (lastButtonState==1 && buttonState==0){
    ...
    digitalWrite(LED, ledState);
    sendRequest("http://"+serverUrl+"/esp/motionAlert/",argument_data);
  }
